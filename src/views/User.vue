...
<UserProfileCard 
  :profile="profile" 
  :init-isFollowed="isFollowed"/> 
  <div class="row">
    <UserFollowersCard :followers="followers"/>
    <UserFavoritedRestaurantsCard :favorRests="favoritedRestaurants"/>  
...
import UserFollowingsCard from '../components/UserProfile/UserFolloingsCard'
  ...
  methods: {
    fetchUserProfile(){
      ...
      this.profile = {
        ...
        FavoritedRestaurants: profile.FavoritedRestaurants.length,
